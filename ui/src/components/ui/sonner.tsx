    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          success: "group-[.toaster]:bg-white group-[.toaster]:text-gray-950 group-[.toaster]:border-gray-200",
          info: "group-[.toaster]:bg-white group-[.toaster]:text-gray-950 group-[.toaster]:border-gray-200",
        },
      }}
      {...props}
    />
